...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER.split("94711469997")
...
global.sudo = process.env.SUDO || '94711469997'
...
module.exports = {
  botname:   process.env.BOT_NAME === undefined ? 'Kawee Botz' : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? 'Kavishka' : process.env.OWNER_NAME,
  ...
  packname:  process.env.PACK_NAME.split("Kawee")[1] === undefined ? 'King-Vajira-Md' : process.env.PACK_NAME.split(";")[1],
